...
storiesOf('Character', module).add('Simple', () => {
  return <div style={{ background: '#4a8841' }}>{CharactersBlock}</div>;
});

storiesOf('Page entry', module).add('Simple', () => {
  return (
    <Router>
      <PageEntryPure
        game={{
...
storiesOf('Page not found', module).add('Simple', () => {
  return (
    <Router>
      <NotFoundPure {...RouteComponentPropsMock} />
    </Router>
  );
});
