...
import { RIVERSIDE_LEFT, RIVERSIDE_RIGHT, ICharacterBase } from 'flux/types';

type ICharacterID<T> = T extends ICharacterBase<infer S> ? S : never;

export const getLeftRightCollocation = <
  T extends ICharacterBase<S>,
  S extends string = ICharacterID<T>
>(
  game: Game<T, S>,
