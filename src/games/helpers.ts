...
const getCharacterDirection = <T extends string>(
  collocation: ICollocationState<T>,
  characterId: T,
): PositionCharacter => {
  ...
  constructor(
    ...
    readonly rules: {
      beforeLanding: Array<{
        description: string;
        check(
          collocation: ICollocationState<S>,
          characterId?: S,
          moveTo?: PositionCharacter,
        ): boolean;
      }>;
