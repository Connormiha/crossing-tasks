...
describe('<PagePlayPure />', () => {
  ...
  it('should render', () => {
    const tree = renderer.create(<PagePlayPure {...params} />).toJSON();
  ...
  it('should render with message', () => {
    const tree = renderer
      .create(<PagePlayPure {...params} message={{ content: 'Test', hidden: false }} />)
      .toJSON();
  ...
  it('should render finished', () => {
    const tree = renderer
      .create(<PagePlayPure {...params} game={{ ...params.game, finished: true }} />)
      .toJSON();
